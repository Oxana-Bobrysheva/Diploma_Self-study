...
urlpatterns = [
    ...
    path(
        "api/courses/<int:pk>/edit/",
        CourseViewSet.as_view({"patch": "edit"}),
        name="api-course-edit",
    ),
    path(
        "api/courses/<int:pk>/add-material/",
        CourseViewSet.as_view({"post": "add_material"}),
    ...
    path(
        "author/<int:teacher_id>/courses/", views.author_courses, name="author_courses"
    ),
    ...
    path(
        "courses/<int:course_id>/add-material/",
    ...
    path(
        "courses/<int:course_id>/materials/<int:material_id>/edit/",
        views.MaterialEditView.as_view(),
        name="material-edit",
    ),
    path(
        "courses/<int:course_id>/materials/<int:material_id>/delete/",
        views.MaterialDeleteView.as_view(),
        name="material-delete",
    ),
    # Testing management URLs
    path(
        "materials/<int:material_id>/create-test/",
        views.TestingCreateView.as_view(),
        name="testing-create",
    ),
    path(
        "testing/<int:testing_id>/",
        views.TestingDetailView.as_view(),
        name="testing-detail",
    ),
    path(
        "testing/<int:testing_id>/update/",
        views.TestingUpdateView.as_view(),
        name="testing-update",
    ),
    path("testing/<int:pk>/take/", views.TestTakeView.as_view(), name="test_take"),
    path(
        "testing/<int:pk>/submit/", views.TestSubmitView.as_view(), name="test_submit"
    ),
    path(
        "attempt/<int:attempt_id>/result/", TestResultView.as_view(), name="test_result"
    ),
    # Question management URLs
    path(
        "testing/<int:testing_id>/questions/create/",
