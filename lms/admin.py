...
class CourseAdmin(admin.ModelAdmin):
    list_display = ('title', 'price', 'owner', 'created_at')  # Columns shown in the list view
...
class MaterialAdmin(admin.ModelAdmin):
    list_display = ('title', 'price', 'course', 'owner', 'created_at')  # Includes course for context
...
class TestAdmin(admin.ModelAdmin):
    list_display = ('material', 'owner', 'created_at')  # Shows linked material
...
class TestResultAdmin(admin.ModelAdmin):
    list_display = ('user', 'test', 'score', 'passed', 'completed_at')  # Key result info
